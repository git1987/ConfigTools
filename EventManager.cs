...
namespace ConfigTools
{
    ...
    public static class EventManager
    {
        ...
        public static bool RemoveListener(EventAction action)
        {
            ...
            Debug.LogWarning("移除监听个数：" + removeCount);
        ...
        public static bool RemoveListener(string key, EventAction action)
        {
            ...
            if (!isRemove) Debug.LogWarning($"{key}中不包含指定的回调");
            return isRemove;
        }
        /// <summary>
        /// 根据标记移除监听
    ...
    public static class EventManager<T>
    {
        ...
        public static void Clear()
        {
            Debug.LogWarning($"clear <{typeof(T).Name}> all events!");
            eventList.Clear();
        }
    }
    ...
    public static class EventManager<T1, T2>
    {
        ...
        public static void Clear()
        {
            Debug.LogWarning($"clear <{typeof(T1).Name}, {typeof(T2).Name}> all events!");
            eventList.Clear();
        }
    }
}